...
if(isset($_POST['inserir'])){
	...
	e inserindo a notícia. Portanto, a notícia
	será associada ao usuário devido ao uso de chave
	estrangeira e relacionamento no banco. */
...
<div class="row">
	<article class="col-12 bg-white rounded shadow my-1 py-4">
		...
		é necessário quando queremos que o formulário
		aceite o envio/processamento de arquivos de qualquer
		natureza. -->
